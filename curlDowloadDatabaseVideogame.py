...
RAW_GITHUB_URL = 'https://github.com/bbrumm/databasestar/blob/main/sample_databases/sample_db_videogames/sqlserver/'
...
for sql_file in sql_files:
    ...
    download_file(file_url, f"VideoGame/{sql_file}")
